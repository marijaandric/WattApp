...
export class FaqPageComponenetsComponent {
  tabs = [
    ...
    { title: 'Who can use your app?', content: 'Naša aplikacija za upravljanje energijom je dostupna za korišćenje svim korisnicima sistema, uključujući i upravljače mreže i potrošače.' },
